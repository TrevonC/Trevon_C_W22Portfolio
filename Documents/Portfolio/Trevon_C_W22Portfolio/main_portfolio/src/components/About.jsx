...
import { BsFillArrowLeftCircleFill, BsFillArrowRightCircleFill, BsFillArrowUpCircleFill, BsFillStopCircleFill } from 'react-icons/bs';
            ...
            <ol class="items-center sm:flex max-w-[1000px] py-4">
                <li class="relative mb-6 sm:mb-0 ">
                    ...
                    <div class="mt-3 sm:pr-8">
                        ...
                        <time class="block mb-2 text-sm font-normal leading-none text-indigo-900">Released on December 2, 2021</time>
                        <p class="text-base font-normal text-[#08192f]">Get started with dozens of web components and interactive elements.</p>
                    </div>
                </li>
                <li class="relative mb-6 sm:mb-0">
                    <div class="flex items-center">
                    ...
                    <div class="mt-3 sm:pr-8">
                        ...
                        <time class="block mb-2 text-sm font-normal leading-none text-indigo-900">Released on December 23, 2021</time>
                        <p class="text-base font-normal text-[#08192f]">Get started with dozens of web components and interactive elements.</p>
                    </div>
                </li>
                <li class="relative mb-6 sm:mb-0">
                    ...
                    <div class="mt-3 sm:pr-8">
                        ...
                        <time class="block mb-2 text-sm font-normal leading-none text-indigo-900">Released on January 5, 2022</time>
                        <p class="text-base font-normal text-[#08192f]">Get started with dozens of web components and interactive elements.</p>
                    </div>
                </li>
            </ol>
            <ol class="items-center sm:flex max-w-[1000px] py-4">
                ...
                <li class="relative mb-6 sm:mb-0">
                    ...
                    <div class="flex z-10 justify-center items-center w-6 h-6 bg-blue-200 rounded-full ring-0 ring-white dark:bg-blue-900 sm:ring-8 dark:ring-gray-900 shrink-0 text-gray-200">
                            <BsFillArrowUpCircleFill size={50} className=""/>
                        </div>
                        <div class="hidden sm:flex w-full bg-gray-200 h-0.5 dark:bg-gray-700"></div>
                        <div class="hidden sm:flex w-full bg-gray-200 h-0.5 dark:bg-gray-700"></div>
                    </div>
                    <div class="mt-3 sm:pr-8">
                        ...
                        <p class="text-base font-normal text-[#08192f]">. Highlights: Data Structures, Agile, Python. </p>
                    </div>
                </li>
            </ol>
            <ol class="items-center sm:flex max-w-[1000px] py-4">
